...
class AddPlatformModal extends React.Component {
  ...
  handlePlatformConfigData = (configData) => {
    ...
    this.setState({
      platform: {
        ...platform,
        Payload1: configData.Payload1,
        Payload2: configData.Payload2,
        Payload3: configData.Payload3,
        Munition1: configData.Munition1,
        Munition2: configData.Munition2,
        Munition3: configData.Munition3,
      }
    }, () => {
      console.log("New state in ASYNC callback:22222", this.state.platform);
    }); 
